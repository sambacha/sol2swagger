...
var port =
  containsAfter(process.argv, '-p') ||
  containsAfter(process.argv, '--port') ||
  process.env.PORT ||
  4730;
...
function runYo(file) {
  execute(
    'yo sol2swagger --apiPath out.json --framework express --creatorName "Shannon Code" --email "genecyber@gmail.com" --githubUser genecyber',
    function (out) {
      console.log(out);
