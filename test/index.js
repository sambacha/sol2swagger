...
var helper = {
  contract: {
    simple: {
      ...
      bytecode:
        '6060604052601e8060106000396000f3606060405260e060020a6000350463e2179b8e8114601a575b005b601856',
    },
  },
  abi: {
    function: {
      ...
      paths: {
        '/simple/deploy': {
          post: {
            ...
            summary: 'post deploy',
            description:
              'deploys the following bytecode 6060604052601e8060106000396000f3606060405260e060020a6000350463e2179b8e8114601a575b005b601856',
            parameters: [],
            responses: {
              '200': {
                description: '200 ok',
...
describe('Path generation', () => {
  it('should throw if provided a event', () => {
    expect(() => {
      template.pathTemplate('get', helper.abi.event.withSingleInput);
    }).to.throw('Operation provided is not a function');
  });
  it('should throw if provided a string', () => {
    expect(() => {
      template.pathTemplate('get', 'invalid');
    }).to.throw('Operation provided is not a function');
  });
  it('should throw if provided multiple functions', () => {
    expect(() => {
      template.pathTemplate('get', helper.abi.functions.multipleValid);
    }).to.throw('Operation provided is not a function');
  });
...
describe('Paths generation', () => {
  it('should generate paths if provided multiple functions', () => {
    ...
    expect(generated.paths).to.jsonEqual(toCheck);
  });
  it('should throw if provided multiple functions with one invalid', () => {
    var toCheck = {};
    expect(() => {
      template.pathsTemplate('get', helper.abi.functions.multipleWithInvalid);
    }).to.throw('Operation provided is not a function');
  });
});
...
describe('Parameters generation', () => {
  ...
  it('should return empty array if provided with zero items', () => {
    expect(template.parametersTemplate(helper.abi.function.withoutInputs.inputs)).to.be.empty;
  });
  it('should return single parameter array', () => {
    ...
    expect(generated).to.have.length.of.at.most(1);
  });
  it('should return multi parameter array', () => {
    ...
    expect(generated).to.have.length.of.at.least(2);
    expect(generated).to.jsonEqual(toCheck);
  });
});
...
describe('Property generation', () => {
  it('should throw if provided a non property', () => {
    expect(() => {
      template.propertyTemplate(helper.abi.event.withSingleInput);
...
describe('Properties generation', () => {
  ...
  it('should return empty array if provided empty object', () => {
    expect(template.propertiesTemplate([])).to.be.jsonEqual({ properties: {} });
  });
});
...
describe('Full Swagger generation', () => {
  it('should throw if provided an object', () => {
    expect(() => {
      template.compileFromAbi({});
    }).to.throw('Object provided should be an array (abi compile)');
  });
  it('should generate when provided an abi', () => {
    var generated = template.compileFromAbi(
      helper.abi.fullToken,
      'token',
      ''
    );
