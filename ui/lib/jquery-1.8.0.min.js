...
(function (a, b) {
      ...
      (e[f] = p._data(c, 'olddisplay')),
        b
          ? (!e[f] && c.style.display === 'none' && (c.style.display = ''),
            c.style.display === '' && bY(c) && (e[f] = p._data(c, 'olddisplay', cb(c.nodeName))))
  ...
  function b_(a, b, c, d) {
    ...
    for (; e < 4; e += 2)
      c === 'margin' && (f += p.css(a, c + bU[e], !0)),
        d
          ? (c === 'content' && (f -= parseFloat(bH(a, 'padding' + bU[e])) || 0),
            c !== 'margin' && (f -= parseFloat(bH(a, 'border' + bU[e] + 'Width')) || 0))
  ...
  function cz(a, c, d, e, f, g) {
    ...
    for (; j < k && (l || !h); j++)
      (h = i[j](c, d, e)),
        typeof h == 'string' &&
          (!l || g[h] ? (h = b) : (c.dataTypes.unshift(h), (h = cz(a, c, d, e, h, g))));
    ...
    (function (a, b) {
        ...
        for (; (e = l[i]) != null && k; i++) {
          ...
          while (e) {
            ...
            for (f in n)
              (j = L[f].exec(e)) &&
                (!m[f] || (j = m[f](j, b, c))) &&
                ((e = e.slice(j.shift().length)), (k = d.push({ part: f, captures: j })));
            if (!k) break;
          }
        }
      ...
      var c,
        ...
        V = T(function (a) {
          ...
          var b =
            h.getElementsByName &&
            h.getElementsByName(q).length === 2 + h.getElementsByName(q + 0).length;
        ...
        Y = T(function (a) {
          return (
            ...
            !a.getElementsByClassName || a.getElementsByClassName('e').length === 0
              ? !1
              : ((a.lastChild.className = 'e'), a.getElementsByClassName('e').length !== 1)
          );
        }),
        Z = function (a, b, c, d) {
          (c = c || []), (b = b || h);
            ...
            ID: g
              ...
              : function (a, c, d) {
                  if (typeof c.getElementById !== j && !d) {
                    ...
                    return e
                      ? e.id === a ||
                        (typeof e.getAttributeNode !== j && e.getAttributeNode('id').value === a)
                        ? [e]
                        : b
                      : [];
                  }
            ...
            PSEUDO: function (a) {
              ...
              return L.CHILD.test(a[0])
                ...
                : (c &&
                    (b = D.exec(c)) &&
                    b.pop() &&
                    ((a[0] = a[0].slice(0, b[0].length - c.length - 1)), (c = b[0].slice(0, -1))),
                  a.splice(2, 3, c || a[3]),
                  a);
            },
          },
          filter: {
            ...
            CLASS: function (a) {
              ...
              return (
                ...
                function (a) {
                  return b.test(
                    a.className || (typeof a.getAttribute !== j && a.getAttribute('class')) || ''
                  );
                }
              );
            },
          ...
          T(function (a) {
            (a.innerHTML = '<select><option selected></option></select>'),
              a.querySelectorAll('[selected]').length ||
                e.push('\\[' + r + '*(?:checked|disabled|ismap|multiple|readonly|selected|value)'),
                ...
                if (d.nodeType === 9)
                  ...
                  try {
                    return (
                      o.apply(
                        f,
                        n.call(l.querySelectorAll(a.replace(C, "[id='" + k + "'] $&")), 0)
                      ),
                      f
                    );
                  } catch (i) {
      ...
      p.cssHooks[b] = {
        ...
        set: function (a, c, d) {
          return b$(
            a,
            c,
            d ? b_(a, b, d, p.support.boxSizing && p.css(a, 'boxSizing') === 'border-box') : 0
          );
        },
      };
    }),
        ...
        function y(a, c, f, i) {
          ...
          if ((a >= 200 && a < 300) || a === 304)
            l.ifModified &&
              ...
              a === 304
                ? ((y = 'notmodified'), (k = !0))
                : ((k = cC(l, u)), (y = k.state), (s = k.data), (t = k.error), (k = !t));
          else {
            t = y;
        ...
        ((l.data && l.hasContent && l.contentType !== !1) || c.contentType) &&
          ...
          x.setRequestHeader(
            ...
            l.dataTypes[0] && l.accepts[l.dataTypes[0]]
              ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== '*' ? ', ' + cw + '; q=0.01' : '')
              : l.accepts['*']
          );
