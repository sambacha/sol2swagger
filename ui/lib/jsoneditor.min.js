...
!(function () {
  ...
  var b = function (a) {
      return 'object' != typeof a || a.nodeType || (null !== a && a === a.window)
        ? !1
        : a.constructor &&
  ...
  (f.prototype = {
          ...
          'undefined' != typeof b[a]
            ? 'required' === a && 'object' == typeof c && Array.isArray(c)
              ...
              : ('string' == typeof c && (c = [c]),
                ...
                1 === f.type.length && 'string' == typeof f.type[0] && (f.type = f.type[0]))
            : (f[a] = c);
        }),
        d(b, function (b, c) {
          ...
          (a.multipleOf || a.divisibleBy) &&
            ...
            g !== Math.floor(g) &&
              k.push({
                ...
                message: this.translate('error_multipleOf', [a.multipleOf || a.divisibleBy]),
              })),
          ...
          a.maxLength &&
            ...
            a.pattern &&
              (new RegExp(a.pattern).test(b) ||
                k.push({ path: e, property: 'pattern', message: this.translate('error_pattern') }));
    ...
    (f.defaults.editors.object = f.AbstractEditor.extend({
      ...
      layoutEditors: function () {
        ...
        if (this.row_container) {
          ...
          if ('grid' === this.format) {
            ...
            for (
              this.layout = JSON.stringify(f), e = document.createElement('div'), a = 0;
              a < f.length;
              a++
            ) {
      ...
      getPropertySchema: function (a) {
        ...
        b = c({}, b);
        var d = this.schema.properties[a] ? !0 : !1;
              ...
              b.preventDefault(),
                ...
                a.collapsed
                  ? ((a.editor_holder.style.display = ''),
                    (a.collapsed = !1),
                    a.setButtonText(a.toggle_button, '', 'collapse', 'Collapse'))
    ...
    (f.defaults.editors.array = f.AbstractEditor.extend({
      ...
      addRow: function (a, b) {
        ...
        c.hide_delete_buttons ||
          ...
          e &&
            !c.hide_move_buttons &&
            ((c.rows[e].moveup_button = this.getButton('', 'moveup', 'Move up')),
          ...
          c.hide_move_buttons ||
            ((c.rows[e].movedown_button = this.getButton('', 'movedown', 'Move down')),
    ...
    (f.defaults.editors.table = f.defaults.editors.array.extend({
      ...
      addRow: function (a) {
        ...
        this.hide_delete_buttons ||
          ...
          c &&
            !this.hide_move_buttons &&
            ((b.rows[c].moveup_button = this.getButton('', 'moveup', 'Move up')),
          ...
          this.hide_move_buttons ||
            ((b.rows[c].movedown_button = this.getButton('', 'movedown', 'Move down')),
    ...
    (f.defaults.editors.select = f.AbstractEditor.extend({
        ...
        if (
          ...
          if (
            ...
            for (h = 0; h < this.schema.enumSource.length; h++)
              'string' == typeof this.schema.enumSource[h]
      ...
      onInputChange: function () {
        var a = this.input.value,
          b = a;
        -1 === this.enum_options.indexOf(a) && (b = this.enum_options[0]),
      ...
      preBuild: function () {
        ...
        for (this.option_keys = [], h = 0; h < b.length; h++)
          this.sanitize(b[h]) === b[h] &&
            (this.option_keys.push(b[h] + ''), (this.select_values[b[h] + ''] = b[h]));
      },
      build: function () {
        var a,
          b = this;
  ...
  (f.AbstractTheme = a.extend({
    ...
    getHeader: function (a, b) {
      ...
      return (
        'string' == typeof a ? (c.textContent = a) : c.appendChild(a),
    ...
    (f.defaults.themes.bootstrap2 = f.AbstractTheme.extend({
      ...
      getFormInputLabel: function (a, b) {
        var c = this._super(a);
        return (
    ...
    (f.defaults.themes.foundation = f.AbstractTheme.extend({
      ...
      getFormInputLabel: function (a, b) {
        var c = this._super(a);
        return (c.style.display = 'inline-block'), b && (c.className += ' required'), c;
      },
      getFormInputField: function (a) {
        var b = this._super(a);
        return (
    ...
    (f.defaults.themes.foundation3 = f.defaults.themes.foundation.extend({
      ...
      getFormInputLabel: function (a, b) {
        var c = this._super(a);
        return (c.style.fontWeight = 'bold'), b && (c.className += ' required'), c;
      },
      getTabHolder: function () {
        var a = document.createElement('div');
        return (
    ...
    (f.plugins = { ace: { theme: '' }, epiceditor: {}, sceditor: {}, select2: {} });
  ...
  f.defaults.resolvers.unshift(function (a) {
    ...
    f.defaults.resolvers.unshift(function (a) {
      return 'boolean' === a.type
        ? 'checkbox' === a.format || (a.options && a.options.checkbox)
          ? 'checkbox'
          : 'select'
        : void 0;
    }),
    ...
    f.defaults.resolvers.unshift(function (a) {
      return 'string' === a.type && a.media && 'base64' === a.media.binaryEncoding
        ? 'base64'
        : void 0;
    }),
    f.defaults.resolvers.unshift(function (a) {
